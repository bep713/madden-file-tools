...
describe('AST Parser unit tests', () => {
    ...
    it('outputs expected buffer sizes', function (done) {
        ...
        pipeline(
            ...
            (err) => {
                ...
                expect(promises.length).to.equal(16);
    ...
    //     pipeline(
    //         fs.createReadStream('D:\\Media\\Games\\NFL Head Coach 09 [U] [BLUS-30128]\\27 - 00b57ccb.ast'),
    //         parser,
    //         (err) => {
    //             if(err) {
    //                 console.error(err);
    ...
    //             expect(promises.length).to.equal(53);
    ...
    //             expect(promises.length).to.equal(1817);
