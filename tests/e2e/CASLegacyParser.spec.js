...
const casIndex = '01';
const testCasPath = 'D:\\Games\\Madden NFL 22\\Data\\Win32\\superbundlelayout\\madden_installpackage_01\\cas_' + casIndex + '.cas';
...
describe('CAS Legacy Parser e2e performance test', () => {
    before(function (done) {
        ...
        legacyParser.on('compressed-data', (data) => {
            ...
            const fileName = 'D:\\GameRips\\Madden 22\\LegacyDump\\01\\' + casIndex + '_' + casHexIndex;
            let fileExtension = '';
