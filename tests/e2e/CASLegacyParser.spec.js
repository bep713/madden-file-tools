...
const casIndex = '03';
const testCasPath = 'D:\\Origin\\Madden NFL 21\\Patch\\Win32\\superbundlelayout\\madden_installpackage_00\\cas_' + casIndex + '.cas';
...
describe('CAS Legacy Parser e2e performance test', () => {
    before(function (done) {
        ...
        legacyParser.on('compressed-data', (data) => {
            ...
            const fileName = 'D:\\GameRips\\Madden 21\\LegacyDump5\\00_Patch\\' + casIndex + '_' + casHexIndex;
            let fileExtension = '';
